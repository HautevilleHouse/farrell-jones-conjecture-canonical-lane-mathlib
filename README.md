# Farrell Jones Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/farrell-jones-conjecture-canonical-lane-mathlib.git
cd farrell-jones-conjecture-canonical-lane-mathlib
lake exe
lake build
```
