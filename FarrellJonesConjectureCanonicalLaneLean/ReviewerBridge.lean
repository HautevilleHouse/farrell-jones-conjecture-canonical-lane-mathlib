...
def reviewerBridgeFiles : List ReviewerBridgeFile := [
  ...
  { path := "artifacts/constants_extracted.json", role := "constant_extracted", sha256 := "b4fb167b340c3e24c1a4a091dbbb241eae0150b9464a00e4b3e4018870b412bf", present := true },
  { path := "artifacts/constants_registry.json", role := "constant_registry", sha256 := "a17f92e22ef4e0c8d1a897908f3f2539dde49d74d4387d40c1f00e100fde7597", present := true },
  ...
  { path := "artifacts/promotion_report.json", role := "promotion_report", sha256 := "48120996acb3060416ddfe2b84607c275409721af7f2e5a6f4109738685c9e63", present := true },
  { path := "repro/repro_manifest.json", role := "manifest", sha256 := "34c7e5612383dc8953a0d40c573792a47801e7327833b8b454dac9c917907a6d", present := true },
...
def reviewerManifestEntries : List ReviewerManifestEntry := [
  { path := "CITATION.cff", sha256 := "2f6f7d94ba39698b865f3e70929468cdbbff54fda2b781f50779035b6a974d90" },
  { path := "README.md", sha256 := "c1900d853539dfd2a8fe327bf08077ee1330a1816264141af4a4526db561d468" },
  { path := "artifacts/constants_extracted.json", sha256 := "b4fb167b340c3e24c1a4a091dbbb241eae0150b9464a00e4b3e4018870b412bf" },
  { path := "artifacts/constants_extraction_inputs.json", sha256 := "80798699ad2b72a44ac55199a9b938b7d22c924478ec9d683baf958c14286309" },
  { path := "artifacts/constants_registry.json", sha256 := "a17f92e22ef4e0c8d1a897908f3f2539dde49d74d4387d40c1f00e100fde7597" },
  { path := "artifacts/promotion_report.json", sha256 := "48120996acb3060416ddfe2b84607c275409721af7f2e5a6f4109738685c9e63" },
  ...
  { path := "paper/EXTRACTION_SPEC.md", sha256 := "3482526eabab589b6b10a80ac38bfbf64ed0c9fdca543e2b83e55204999329b5" },
